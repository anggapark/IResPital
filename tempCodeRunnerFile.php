...
if(isset($_POST['book1'])){
	...
	$id= mysqli_fetch_array(mysqli_query($koneksi,"SELECT TOP 1 id_pasien FROM tpasien ORDER BY id_pasien DESC"));  
 
    //persiapan query simpan data
    $simpan = mysqli_query($koneksi,"INSERT INTO tappointment  VALUES ('','$id','1','$tanggal','$waktu','$keluhan')");
...
if(isset($_POST['book2'])){
    ...
    //persiapan query simpan data
    $simpan = mysqli_query($koneksi,"INSERT INTO tappointment  VALUES ('','$id',2,'$tanggal','$waktu','$keluhan')");
...
if(isset($_POST['book3'])){
    ...
    //persiapan query simpan data
    $simpan = mysqli_query($koneksi,"INSERT INTO tappointment  VALUES ('','$id',3,'$tanggal','$waktu','$keluhan')");
...
if(isset($_POST['book4'])){
    ...
    //persiapan query simpan data
    $simpan = mysqli_query($koneksi,"INSERT INTO tappointment  VALUES ('','$id',4,'$tanggal','$waktu','$keluhan')");
