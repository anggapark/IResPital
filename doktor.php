				...
				<div class="row">
					<div class="col-md-6">
						<div class="box_list wow fadeIn">
							...
							<figure>
								<a href="bill.php"><img src="assets/img/doktor.jpg" class="img-fluid" alt="">
								</a>
							</figure>
							<div class="wrapper">
					...
					<div class="col-md-6">
						<div class="box_list wow fadeIn">
							...
							<figure>
								<a href="bill.php"><img src="assets/img/doktor2.jpg" class="img-fluid" alt="">
								</a>
							</figure>
							<div class="wrapper">
								<small>Dokter Umum</small>
					...
					<div class="col-md-6">
						<div class="box_list wow fadeIn">
							...
							<figure>
								<a href="bill.php"><img src="assets/img/doktor3.jpeg" class="img-fluid" alt="">
								</a>
							</figure>
							<div class="wrapper">
								<small>Dokter Umum</small>
					...
					<div class="col-md-6">
						<div class="box_list wow fadeIn">
							...
							<figure>
								<a href="bill.php"><img src="assets/img/doktor4.png" class="img-fluid" alt="">
								</a>
							</figure>
							<div class="wrapper">
								<small>Dokter Umum</small>
